...
namespace nojiang\Taobaoke\Libraries;

use nojiang\Taobaoke\Libraries\Base;
use nojiang\Taobaoke\SDK\top\request\TbkItemGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkItemRecommendGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkItemInfoGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkShopGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkShopRecommendGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkUatmEventGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkUatmEventItemGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkUatmFavoritesItemGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkUatmFavoritesGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkJuTqgGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkSpreadGetRequest;
use nojiang\Taobaoke\SDK\top\domain\TbkSpreadRequest;
use nojiang\Taobaoke\SDK\top\request\JuItemsSearchRequest;
use nojiang\Taobaoke\SDK\top\domain\TopItemQuery;
use nojiang\Taobaoke\SDK\top\request\TbkDgItemCouponGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkCouponGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkTpwdCreateRequest;
use nojiang\Taobaoke\SDK\top\request\TbkDgNewuserOrderGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkScNewuserOrderGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkScMaterialOptionalRequest;
use nojiang\Taobaoke\SDK\top\request\TbkDgMaterialOptionalRequest;
use nojiang\Taobaoke\SDK\top\request\TbkDgNewuserOrderSumRequest;
use nojiang\Taobaoke\SDK\top\request\TbkScNewuserOrderSumRequest;
use nojiang\Taobaoke\SDK\top\request\WirelessShareTpwdCreateRequest;
use nojiang\Taobaoke\SDK\top\domain\GenPwdIsvParamDto;
use nojiang\Taobaoke\SDK\top\request\WirelessShareTpwdQueryRequest;
use nojiang\Taobaoke\SDK\top\request\TbkContentGetRequest;
use nojiang\Taobaoke\SDK\top\request\TbkDgOptimusMaterialRequest;
use nojiang\Taobaoke\SDK\top\request\TbkScOptimusMaterialRequest;
use nojiang\Taobaoke\SDK\top\request\TbkCouponConvertRequest;
use nojiang\Taobaoke\SDK\top\request\TbkItemConvertRequest;
use nojiang\Taobaoke\SDK\top\request\TbkShopConvertRequest;
use nojiang\Taobaoke\SDK\top\request\TbkTpwdConvertRequest;
